...
public final class Constants {
	...
	public final static String dbPath = "com/hx/blog/config/HXBlog.db";
	public final static String configPath = "com/hx/blog/config/config.json";
	public final static String resumePath = "com/hx/blog/config/resume.json";
	public final static String backupConfPath = "com/hx/blog/config/backup.json";
...
//	public final static long logFileThreshold = 2 << 10;
	...
	// "userName", "toekn"
	// 用户名, token, 密码md5 [123]
	public final static String _ACCOUNT_NAME = "userName";
...
//	public final static Pattern specCharPattern = Pattern.compile(".*[!-/|:-@|{-~|\\[/\\]^—、].*");
	...
	// 默认的ValidateResult
	public final static ValidateResult validateResultTrue = new ValidateResult(true, null);
	...
	// 参数传递的相关常量		add at 2016.08.05
	public final static String id = "id";
	public final static String blogId = "blogId";
	public final static String blogIdx = "blogIdx";
	public final static String floorIdx = "floorIdx";
	public final static String imageIdx = "imageIdx";
